...
module ProductFilters
  ...
  def ProductFilters.price_filter
    conds = [ [ I18n.t("lower"),          "price             <= 100"   ],
              [ I18n.t("first_range"),    "price between 100 and 300" ],
              [ I18n.t("second_range"),   "price between 300 and 800" ],
              [ I18n.t("fourth_range"),   "price between 800 and 1000"],
              [ I18n.t("upper"),          "price             >= 1000"  ] ]
